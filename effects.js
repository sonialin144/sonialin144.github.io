...
// i dont remember why i added links this way 
  window.addEventListener("load", function() {
   ...
   // document.querySelector(".hunt").addEventListener("click", ()=>{window.location = "https://tommyho.itch.io/yume";})
    ...
    document.querySelector(".a2go").addEventListener("click", ()=>{window.location = "a2go.html";})
    ...
    document.querySelector(".vocab").addEventListener("click", ()=>{window.location = "niantic.html";})
    //deployment test
